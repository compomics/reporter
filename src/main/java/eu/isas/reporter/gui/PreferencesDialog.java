 ...
 *
 * Created on Mar 25, 2011, 3:36:39 PM
 */
...
public class PreferencesDialog extends javax.swing.JDialog {
    ...
    public PreferencesDialog(ReporterGUI parent, QuantificationPreferences quantificationPreferences) {
        super(parent, true);
        this.parent = parent;
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if (validateInput()) {
            saveValues();
            parent.updateResults(quantificationPreferences);
            dispose();
        }
